...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    moreDetails: 'Would you like more details about any of these programs?',
  ...
  es: {
    ...
    moreDetails: '¿Te gustaría más detalles sobre alguno de estos programas?',
  ...
  zh: {
    ...
    moreDetails: '您想了解这些项目中任何一个的更多详细信息吗？',
  ...
  vi: {
    ...
    moreDetails: 'Bạn có muốn biết thêm chi tiết về bất kỳ chương trình nào trong số này không?',
